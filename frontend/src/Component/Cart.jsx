                ...
                cart.length ?
                    <>
                                ...
                                <tbody>
                                    {
                                        cart?.map((item) => {
                                            return <tr key={item.id}>
                                                ...
                                                <td>&#8377;{item.total}</td>
                                                {
                                                    props.title === "Checkout" ? null : <td><button onClick={() => daleteRecord(item.id)} className='btn btn-danger'><i className='fa fa-trash'></i></button></td>
                                                }
                                            </tr>
                                        })
                                    }
                        ...
                        <div className="row">
                            ...
                            <div className={`${props.title === "Checkout" ? 'col-md-12' : 'col-md-6'}`}>
