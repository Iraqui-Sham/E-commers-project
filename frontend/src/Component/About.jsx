                ...
                <div className="container">
                    <div className="row g-5">
                        <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <h5 className="mb-3">
                                <i className="far fa-check-circle text-primary me-3"></i>14 Days Refaund Policy
                            </h5>
                            <h5 className="mb-3">
                                <i className="far fa-check-circle text-primary me-3"></i>Fast Delivery
                            </h5>
                            <h5 className="mb-3">
                                <i className="far fa-check-circle text-primary me-3"></i>100% Genuine Product
                            </h5>
                            <Link className="btn btn-primary py-3 px-5 mt-3" to="/shop">Shop Now</Link>
                        </div>
                        <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div className="img-border">
                                <img className="img-fluid" src="img/img8.jpg" alt="Banner Image" />
                            </div>
                        </div>
                    </div>
                </div>
