    ...
    <>
      ...
      <div className="container-xxl py-5">
        <div className="container">
          <div className="row">
            <div className="col-lg-3 col-sm-6 card p-4 bg-primary mb-5 border-5 border-light">
              <h3 className='text-light text-center mt-2'><i className='fa fa-map-marker'></i> Address</h3>
              <p className='text-light text-center'>A-43, Sector 16, Noida, UP, 201301, India</p>
            </div>
            <div className="col-lg-3 col-sm-6 card p-4 bg-primary mb-5 border-5 border-light">
              <h3 className='text-light text-center mt-3'><i className='fa fa-envelope'></i> Email Address</h3>
              <Link to="mailto:alammdshamsher956@gmail.com" target='blank' rel="noreferrer" className='text-light text-center'>alamshamsher@gmail.com</Link>
            </div>
            <div className="col-lg-3 col-sm-6 card p-4 bg-primary mb-5 border-5 border-light">
              <h3 className='text-light text-center mt-3'><i className='fa fa-phone'></i> phone</h3>
              <Link to="tel:+919110112197" target='blank' rel="noreferrer" className='text-light text-center'>+91-9110112197</Link>
            </div>
            <div className="col-lg-3 col-sm-6 card p-4 bg-primary mb-5 border-5 border-light">
              <h3 className='text-light text-center mt-3'><i className='fa fa-whatsapp'></i> Whats-App</h3>
              <Link to="https://wa.me/+919110112197" target='blank' rel="noreferrer" className='text-light text-center'>+91-9110112197</Link>
            </div>
          </div>
          <div className="row g-5">
              ...
              <form onSubmit={postData}>
                ...
                <div className="row">
                  <div className="col-md-6 mb-3">
                    <label>Email*</label>
                    <input type='text' name='email' value={data.email} onChange={getInputData} className={`form-control border-3 ${show && errorMessage.email ? 'border-danger' : 'border-primary'}`} placeholder='Email Address' />
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
              <div className="h-100" style={{ minHeight: "400px" }}>
                <iframe width="100%" height="550" id="gmap_canvas" src="https://maps.google.com/maps?q=a-43%20sector%2016%20noida&t=&z=13&ie=UTF8&iwloc=&output=embed" ></iframe>
              </div>
            </div>
          </div>
        </div>
