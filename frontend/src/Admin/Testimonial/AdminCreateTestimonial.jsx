                ...
                <div className="row">
                    ...
                    <div className="col-md-9">
                        ...
                        <form onSubmit={postData}>
                            ...
                            <div className="mb-3">
                                <label>Message*</label>
                                <textarea name='message' onChange={getInputData} placeholder='Message...' className={`form-control border-3 ${show && errorMessage.message ? 'border-danger' : 'border-primary'}`} rows={5} ></textarea>
                            </div>
