...
export default function AdminUpdateTestimonial() {
    ...
    function postData(e) {
        ...
        if (error)
            ...
            let item = TestimonialStateData.find((x) => x.name.toLocaleLowerCase() === data.name.toLocaleLowerCase() && x.id != id)    // current product nhi hona chahiye koi aur hona chahiye  
            if (item) {
                setShow(true)
                setErrorMessage((old) => {
                    return {
                ...
                <div className="row">
                    ...
                    <div className="col-md-9">
                        ...
                        <form onSubmit={postData}>
                            ...
                            <div className="mb-3">
                                <label>Message*</label>
                                <textarea name='message' value={data.message} onChange={getInputData} placeholder='Message...' className={`form-control border-3 ${show && errorMessage.message ? 'border-danger' : 'border-primary'}`} rows={5} ></textarea>
                            </div>

                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    <label>Pic*</label>
                                    <input type="file" name='pic' onChange={getInputData} placeholder='Testimonial Name' className={`form-control border-3 ${show && errorMessage.pic ? 'border-danger' : 'border-primary'}`} />
