...
export default function AdminNewsletter() {
    ...
    function updateRecord(id) {
        if (window.confirm("Are You Sure to Update Status of that Item : ")) {
            ...
            dispatch(updateNewsletter({ ...item, active: !item.active }))                 // backend me update
            data[index].active = !(data[index].active)                                // localstorage (browser) me change
            setFlag(!flag)                                                            // instant render (state changing)
        }
    }
