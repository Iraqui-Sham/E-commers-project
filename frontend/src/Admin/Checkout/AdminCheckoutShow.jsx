...
export default function AdminCheckoutShow() {
    ...
    // jab bhi CheckoutStateData.length change hoga useEffect chalega 
    return (
        <>
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-md-9">
                                    ...
                                    <td>{data.orderStatus}
                                        {
                                            data.orderStatus !== "Delivered" ?
                                                <>
                                                    <br />
                                                    <br />
                                                    <select name='orderStatus' onChange={(e) => setOrderStatus(e.target.value)} value={orderStatus} className='from-select border-3 border-primary'>
                                    ...
                                    <td>{data.paymentStatus}
                                        {
                                            data.paymentStatus !== "Done" ?
                                                <>
                                                    <br />
                                                    <br />
                                                    <select name='paymentStatus' onChange={(e) => setPaymentStatus(e.target.value)} value={paymentStatus} className='from-select border-3 border-primary'>
                        ...
                        <h5 className='bg-primary text-light text-center p-2'>Order Product Details</h5>
